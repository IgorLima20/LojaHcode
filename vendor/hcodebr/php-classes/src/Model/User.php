...
class User extends Model
{
    ...
    public static function listAll()
    {
        ...
        return $sql->select("SELECT * FROM tb_users u INNER JOIN tb_persons p USING(idperson) 
    ...
    public function save()
    {
        ...
        $results = $sql->select("CALL sp_users_save(:desperson, :deslogin, :despassword, :desemail, 
            ...
            ":desemail"    => utf8_decode($this->getdesemail()),
    ...
    public function get($iduser)
    {
        ...
        $results = $sql->select("SELECT * FROM tb_users u INNER JOIN tb_persons p USING(idperson) 
    ...
    public static function getSucces()
    {
    ...
    public static function clearSucces()
    {
