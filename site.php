...
$app->post('/cart/add', function () use($app) {
    ...
    $valores = [
        ...
        "produtos" => $cart->getProduct($_POST['id'])
    ];
...
$app->post('/cart/minus', function () use($app) {
...
$app->post('/cart/remove', function() use($app) {
    $product = new Product();
...
$app->post('/profile', function () {
    ...
    User::setSuccess("Dados alterados com sucssso.");
...
$app->get('/profile/change-password', function () {
    ...
    $page->setTpl("profile-change-password", [
        ...
        'changePassSuccess' => User::getSucces()
    ]);
});
