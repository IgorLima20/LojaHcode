            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="shopping-item">
                        <a href="/cart">Carrinho - <span id="carrinhoTotalHeader" class="cart-amunt">R$<?php echo getCartVlSubTotal(); ?></span> <i
                                class="fa fa-shopping-cart"></i> <span id="quantidadeProdutoHeader" class="product-count"><?php echo getCartNrQtd(); ?></span></a>
                    </div>
                </div>
            </div>
        </div>
